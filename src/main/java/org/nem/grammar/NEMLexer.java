...
public class NEMLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IL_COMMENT", "ML_COMMENT", "WHITESPACE", "PLUS", "MINUS", "STAR", "SLASH", 
			"MODULO", "OPEN_PARENTHESIS", "CLOSE_PARENTHESIS", "OPEN_BRACE", "CLOSE_BRACE", 
			"OPEN_CHEVRON", "CLOSE_CHEVRON", "POINT", "COMMA", "COLON", "SEMICOLON", 
			"EXCLAMATION", "EQ", "ADD_EQ", "SUB_EQ", "MUL_EQ", "DIV_EQ", "MOD_EQ", 
			"INCR", "DECR", "FN", "VAR", "CONST", "RETURN", "VOID", "INT", "Z", "B", 
			"O", "D", "H", "L_BIN", "L_OCT", "L_HEX", "L_INT", "L_NUM", "IDENTIFIER"
		};
	}
	...
	public NEMLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "NEMLexer.g4"; }
