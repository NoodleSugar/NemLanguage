...
public class NEMLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"EXCLAMATION", "EQ", "EQ_ADD", "EQ_SUB", "EQ_MUL", "EQ_DIV", "INCR", 
			"DECR", "FN", "VAR", "CONST", "RETURN", "VOID", "INT", "Z", "B", "O", 
			"D", "H", "L_BIN", "L_OCT", "L_HEX", "L_INT", "L_NUM", "IDENTIFIER"
		};
	}
