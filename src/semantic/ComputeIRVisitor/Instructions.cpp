...
void ComputeIRVisitor::visitInstr(const Node& node)
{
	...
	case AstType::FunctionCall:
		visit(node_cast<FunctionCall>(node));
		break;
	case AstType::Block:
		visit(node_cast<Block>(node));
		break;
	case AstType::Declaration:
		visit(node_cast<Declaration>(node));
		break;
	case AstType::Definition:
		visit(node_cast<Definition>(node));
		break;
	case AstType::Assignment:
		visit(node_cast<Assignment>(node));
		break;
	case AstType::Return:
		visit(node_cast<Return>(node));
		break;
	default:
