...
#define X(T)                                              \
	bool operator==(const T##Node& o1, const T##Node& o2) \
	{                                                     \
		return static_cast<T>(o1) == static_cast<T>(o2);  \
	}
LIST_OF_NODE_TYPES
#undef X
...
#define X(T)         \
	case AstType::T: \
		return node_cast<nem::ast::T>(o1) == node_cast<nem::ast::T>(o2);
		LIST_OF_AST_TYPES
#undef X
	}
}
...
bool operator==(const Variable& o1, const Variable& o2)
{
	return o1.name == o2.name;
}
